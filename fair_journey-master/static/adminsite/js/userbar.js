...
document.addEventListener('DOMContentLoaded', function userBar(e) {
    var userbar = document.querySelector('[data-webgui-userbar]');
    var trigger = userbar.querySelector('[data-webgui-userbar-trigger]');
    var list = userbar.querySelector('.webgui-userbar-items');
